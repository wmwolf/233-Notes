...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Ionization Parameter} % (fold)
...
% ssubsection ionization_parameter (end)
...
\subsection{Evidence for Dust Grains} % (fold)
...
% subsection evidence_for_dust_grains (end)
\subsection{Obscuring Effects of Dust} % (fold)
...
% subsection obscuring_effects_of_dust (end)
\subsection{Thermal Properties of Grains} % (fold)
...
\end{equation}
Here $j=\kappa B_\nu(T_{\mathrm{dust}})$
% subsection thermal_properties_of_grains (end)
% section dust (end)
%%%%%%%%%%%%%%%%%%%%%%%%%
% MONDAY, MARCH 3, 2014 %
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Global ISM} % (fold)
...
% TODO Missed a couple bullet points.
...
\subsection{The Two-Phase Medium} % (fold)
...
% TODO two-phase medium figures (T vs. n_H and T vs P/k)
% subsection the_two_phase_medium (end)
% subsection gas_phases (end)
% section global_ism (end)
\section{Molecules in the ISM} % (fold)
...
\textit{Monday, March 5, 2014}\\
  ...
  % subsection composition (end)
  \subsection{Formation and Destruction of Molecular Hydrogen} % (fold)
  ...
  correctly, radiative transfer calculations are required.
    % subsection formation_of_molecular_hydrogen (end)
  \subsection{Measuring Cloud Masses} % (fold)
  ...
  % subsection measuring_cloud_masses (end)
  \subsection{Electric Dipole Mission from CO} % (fold)
  ...
  % subsection electric_dipole_mission_from_co (end)
  \subsection{Rotational Levels of \Htwo} % (fold)
  ...
  % subsection rotational_levels_of_htwo (end)

% section molecules_in_the_ism (end)
\end{document}
